...
const DEFAULT_TRANSLATIONS = {
  zh: {
    ...
    amazon_updated: '数据更新:',
    amazon_update_schedule: '热销=Amazon 西班牙公开畅销榜；最想拥有=愿望清单/收藏趋势榜。按类目汇总整理，每周五更新。',
    ...
    calc_discount: '折扣计算器',
    calc_vat: '增值税计算器',
    calc_scientific: '科学计算器',
    calc_product_cost: '产品成本',
    calc_markup: '加价率',
    calc_customer_cost: '客户成本',
    calc_shipping_cost: '运费成本',
    calc_selling_price: '售价',
    calc_profit: '利润',
    calc_profit_calculator: '利润计算器',
    calc_online: '在线计算器',
    calc_profit_margin_short: '利润率',
    calc_product_cost_eur: '产品成本 (€)',
    calc_markup_percent: '加价率 (%)',
    calc_customer_cost_optional: '客户成本 (可选)',
    calc_shipping_optional: '运费 (可选)',
    calc_profit_margin: '利润率',
    calc_total_cost: '总成本',
    calc_original_price: '原价',
    calc_discount_rate: '折扣率',
    calc_discounted_price: '折后价',
    calc_savings: '节省金额',
    calc_price_ex_vat: '不含税价格',
    calc_price_inc_vat: '含税价格',
    calc_tax_rate: '税率',
    calc_vat_amount: '增值税额',
    calc_add_tax: '加税计算',
    calc_remove_tax: '去税计算',
    calc_reset: '重置',
    calc_calculate: '计算',
    calc_history: '历史记录',
    calc_no_history: '暂无历史记录',
    calc_result: '计算结果',
    calc_clear: '清除',
    calc_memory: '内存',
    nav_exchange: '汇率查询',
    amazon_member_note: '注册会员可查看完整 Top100 数据',
    google_member_note: '注册会员可查看完整 Top50 数据',
    film_member_note: '非会员每日可查询 3 次，注册会员无限使用',
    exchange_title: '实时汇率',
    exchange_desc: '获取最新的货币汇率信息',
    exchange_last_updated: '最后更新',
    exchange_base_currency: '基础货币',
    exchange_target_currency: '目标货币',
    exchange_amount: '金额',
    exchange_converted: '转换后金额',
    exchange_refresh: '刷新汇率',
    exchange_error: '获取汇率失败',
    exchange_no_data: '暂无数据',
    cur_USD: '美元',
    cur_EUR: '欧元',
    cur_GBP: '英镑',
    cur_JPY: '日元',
    ...
    google_updated: '数据更新:',
    google_update_schedule: '基于 Google Merchant Center / Shopping 西班牙市场公开热度与趋势数据，按类目汇总周度选品参考，每周五更新。',
    google_no_data: '暂无数据',
  ...
  en: {
    ...
    amazon_update_schedule: 'Bestseller uses Amazon Spain public sales rankings; Most Wanted uses wishlist/save trend rankings. Grouped by category and updated every Friday.',
    ...
    calc_profit: 'Profit Calculator',
    calc_discount: 'Discount Calculator',
    calc_vat: 'VAT Calculator',
    calc_scientific: 'Scientific Calculator',
    calc_product_cost: 'Product Cost',
    calc_markup: 'Markup',
    calc_customer_cost: 'Customer Cost',
    calc_shipping_cost: 'Shipping Cost',
    calc_selling_price: 'Selling Price',
    calc_profit: 'Profit',
    calc_profit_calculator: 'Profit Calculator',
    calc_online: 'Online Calculator',
    calc_profit_margin_short: 'Profit Margin',
    calc_product_cost_eur: 'Product Cost (€)',
    calc_markup_percent: 'Markup (%)',
    calc_customer_cost_optional: 'Customer Cost (Optional)',
    calc_shipping_optional: 'Shipping (Optional)',
    calc_profit_margin: 'Profit Margin',
    calc_total_cost: 'Total Cost',
    calc_original_price: 'Original Price',
    calc_discount_rate: 'Discount Rate',
    calc_discounted_price: 'Discounted Price',
    calc_savings: 'Savings',
    calc_price_ex_vat: 'Price Excl. VAT',
    calc_price_inc_vat: 'Price Incl. VAT',
    calc_tax_rate: 'Tax Rate',
    calc_vat_amount: 'VAT Amount',
    calc_add_tax: 'Add Tax',
    calc_remove_tax: 'Remove Tax',
    calc_reset: 'Reset',
    ...
    calc_clear: 'Clear',
    calc_memory: 'Memory',
    nav_exchange: 'Exchange Rates',
    amazon_member_note: 'Members can view full Top 100 data',
    google_member_note: 'Members can view full Top 50 data',
    film_member_note: 'Free users: 3 searches/day. Members: unlimited',
    exchange_title: 'Exchange Rates',
    exchange_desc: 'Get the latest currency exchange rate information',
    exchange_last_updated: 'Last Updated',
    exchange_base_currency: 'Base Currency',
    exchange_target_currency: 'Target Currency',
    exchange_amount: 'Amount',
    exchange_converted: 'Converted Amount',
    exchange_refresh: 'Refresh Rates',
    exchange_error: 'Failed to fetch exchange rates',
    exchange_no_data: 'No Data Available',
    cur_USD: 'US Dollar',
    cur_EUR: 'Euro',
    ...
    google_updated: 'Data updated:',
    google_update_schedule: 'Based on public Google Merchant Center / Shopping Spain demand and trend signals, grouped by category as a weekly sourcing reference. Updated every Friday.',
  ...
  es: {
    ...
    amazon_update_schedule: 'Más vendidos usa rankings públicos de ventas de Amazon España; Más deseados usa tendencias de listas de deseos/guardados. Agrupado por categoría y actualizado cada viernes.',
    ...
    calc_profit: 'Calculadora de ganancias',
    calc_discount: 'Calculadora de descuento',
    calc_vat: 'Calculadora de IVA',
    calc_scientific: 'Calculadora científica',
    calc_product_cost: 'Costo del producto',
    calc_markup: 'Margen',
    calc_customer_cost: 'Costo del cliente',
    calc_shipping_cost: 'Gastos de envío',
    calc_selling_price: 'Precio de venta',
    calc_profit: 'Ganancia',
    calc_profit_calculator: 'Calculadora de ganancias',
    calc_online: 'Calculadora en línea',
    calc_profit_margin_short: 'Margen de ganancia',
    calc_product_cost_eur: 'Costo del producto (€)',
    calc_markup_percent: 'Margen (%)',
    calc_customer_cost_optional: 'Costo del cliente (opcional)',
    calc_shipping_optional: 'Envío (opcional)',
    calc_profit_margin: 'Margen de ganancia',
    calc_total_cost: 'Costo total',
    calc_original_price: 'Precio original',
    calc_discount_rate: 'Tasa de descuento',
    calc_discounted_price: 'Precio rebajado',
    calc_savings: 'Ahorro',
    calc_price_ex_vat: 'Precio sin IVA',
    calc_price_inc_vat: 'Precio con IVA',
    calc_tax_rate: 'Tasa impositiva',
    calc_vat_amount: 'Importe del IVA',
    calc_add_tax: 'Añadir IVA',
    calc_remove_tax: 'Quitar IVA',
    calc_reset: 'Restablecer',
    calc_calculate: 'Calcular',
    calc_history: 'Historial',
    calc_no_history: 'Sin historial',
    calc_result: 'Resultado',
    calc_clear: 'Limpiar',
    calc_memory: 'Memoria',
    nav_exchange: 'Tipos de Cambio',
    amazon_member_note: 'Los miembros pueden ver los Top 100',
    google_member_note: 'Los miembros pueden ver los Top 50',
    film_member_note: 'Usuarios gratuitos: 3 búsquedas/día. Miembros: ilimitado',
    exchange_title: 'Tipos de Cambio',
    exchange_desc: 'Obtenga la información más reciente sobre tipos de cambio',
    exchange_last_updated: 'Última Actualización',
    exchange_base_currency: 'Moneda Base',
    exchange_target_currency: 'Moneda Objetivo',
    exchange_amount: 'Cantidad',
    exchange_converted: 'Cantidad Convertida',
    exchange_refresh: 'Actualizar Tasas',
    exchange_error: 'Error al obtener tipos de cambio',
    exchange_no_data: 'Sin Datos Disponibles',
    cur_USD: 'Dólar Estadounidense',
    cur_EUR: 'Euro',
    cur_GBP: 'Libra Esterlina',
    cur_JPY: 'Yen Japonés',
    cur_CNY: 'Yuan Chino',
    cur_CAD: 'Dólar Canadiense',
    cur_AUD: 'Dólar Australiano',
    cur_CHF: 'Franco Suizo',
    ...
    google_updated: 'Datos actualizados:',
    google_update_schedule: 'Basado en señales públicas de demanda y tendencias de Google Merchant Center / Shopping España, agrupadas por categoría como referencia semanal de selección. Actualizado cada viernes.',
