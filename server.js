...
const DEFAULT_TRANSLATIONS = {
  zh: {
    ...
    title_amazon: 'Amazon榜单',
    subtitle_amazon: '查看Amazon热门产品排行榜',
  ...
  en: {
    ...
    title_amazon: 'Amazon Bestsellers',
    subtitle_amazon: 'View Amazon hot product rankings',
  ...
  es: {
    ...
    title_amazon: 'Ranking Amazon',
    subtitle_amazon: 'Ver rankings de productos populares de Amazon',
    tagline_amazon: 'Selección curada para ayudarte a comprar smarter',
